        ...
        return(
            <div>
                ...
                <form onSubmit={this.subForm}>
                    Clave: <input type='text' name='ide' onChange={this.campoChange} /><br />
                    Nombre: <input type='text' name='nombre' onChange={this.campoChange}/><br />
                    Apellidos: <input type='text' name='apellidos' onChange={this.campoChange}/><br />
                    Sexo:   <input type='radio' name='sexo' value='F' onClick={this.campoChange} />Femenino
                            <input type='radio' name='sexo' value='M' onClick={this.campoChange} />Masculino <br />
                    Edad: <input type='text' name='edad' onChange={this.campoChange}/><br />
                    Salario:<input type='text' name='salario' onChange={this.campoChange}/><br />
                    Foto:<input type='text' name='foto' onChange={this.campoChange}/><br />
                    Area: <select name='ida' onChange={this.campoChange}>
                        {areas.map((areas,i) =>
